...
def process_args(args):
    ...
    """
    run = wandb.init(project="mlops_project_segregate", job_type="split_data")
...
# mlflow run . -P input_artifact="mlops_project_preprocess/data_preprocessed.csv:latest" -P artifact_root="data" -P artifact_type="trainvaltest_data" -P test_size=0.3 -P random_state="9"
